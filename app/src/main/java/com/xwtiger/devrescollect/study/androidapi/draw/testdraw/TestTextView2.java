...
public class TestTextView2 extends TextView {
    ...
    private  String tag = "textview2";

    public TestTextView2(Context context) {
        super(context);
    }

    public TestTextView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TestTextView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

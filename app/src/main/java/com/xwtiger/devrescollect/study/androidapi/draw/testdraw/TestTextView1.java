...
public class TestTextView1 extends TextView {


    private  String tag = "textview1";

    public TestTextView1(Context context) {
        super(context);
    }

    public TestTextView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TestTextView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

...
public class MyTextView2 extends TextView {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev){
        Log.d("testevent", "【农民2】任务<" + Utils.actionToString(ev.getAction()) + "> : 需要分派，我下面没人了，怎么办？自己干吧");
    ...
    public boolean onTouchEvent(MotionEvent ev){
        boolean bo = false;
        Log.d("testevent", "【农民2】任务<" + Utils.actionToString(ev.getAction()) + "> : 自己动手，埋头苦干。能解决？" + bo);
        return bo;
    }
